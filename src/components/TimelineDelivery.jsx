                        ...
                        return (
                            <li className={`card-`} key={key}>
                                <div className={`sm:p-20 p-5 relative z-10`}>
                                    <span className={`border-[#fff] text-[#13589c] bg-[#fff] border-[2px] year ${isOddItem ? ' !right-[-57px] !left-auto' : ''}`}>
                                        {key+1}
                                    </span>
                                    <div className="content">
                                        ...
                                        <p className={`md:text-[1.125rem] text-[1rem]`} dangerouslySetInnerHTML={{ __html: item.content }} />
                                    </div>
                                </div>
                            </li>
                        );
