    ...
    return (
        <>
            ...
            <div className="card card-effect rounded-[30px] sm:p-[40px] p-[24px]">
                    <h3 className="heading-3 sm:mb-[16px] mb-[8px]">Our Guarantee; No SPAM and your data is safe with us!
                    </h3>
                    <div>
                        <div className="grid gap-5 ">
                           <div className="grid gap-4 mt-5">
                                <input
                                    className={`${errors.website ? 'border-red-500' : null} input-custom`}
                                    value={website}
                                ...
                                <input
                                    className={`${errors.place ? 'border-red-500' : null} input-custom`}
                                    value={place}
