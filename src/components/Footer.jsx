              ...
              <div className="inner-2">
                <div>
                  ...
                  <ul className="list-wrpr">
                    ...
                    <li>
                      <Link
                        title="Branding and Digital Marketing UAE"
                        aria-label="Contact"
                  ...
                  <ul className="list-wrpr">
                    ...
                    <li>
                      <Link
                        ...
                        aria-label="Brand Collateral"
                        href="/brand-collateral"
                        className="link-hover">
                        Brand Collateral
                      </Link>
                    </li>
                   <li>
                    ...
                    <li>
                      <Link
                        ...
                        href="/e-commerce-websites-development/"
                        className="link-hover">
                        e-Commerce Website
                      </Link>
                    </li>
                    <li className="list  sm:mb-[8px] mb-[12px]">
                      <Link
                  ...
                  <ul className="list-wrpr">
                    {contactData && (
                      <>
                        ...
                        <li>
                          <Link
                            title={contactData && contactData.phone}
                            aria-label="Phone"
                        ...
                        <li>
                          <Link
                            title={contactData && contactData.email}
                            aria-label="Email"
                            href={`mailto:${contactData && contactData.email}`}
                            className="link-hover">
