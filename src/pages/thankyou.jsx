            ...
            <section style={{ marginTop: '-120px' }} className="hero sm:h-screen h-[80vh] flex items-center sm:py-20 py-6 overflow-hidden relative text-center">
                ...
                <div className="container z-10 relative">
                    <div className="grid gap-10">
                        ...
                        <p className="md:text-[1.6rem] text-[1rem]" data-aos="fade-up" data-delay="500">Our SEO Expert will inspect your website and revert to you with SEO Audit Report.</p>
                    </div>
                </div>
                <BackgroundAnimation />
            </section>
